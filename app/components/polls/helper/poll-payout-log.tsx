...
function buildWhatsAppLink(record: PayoutRecord, kind: "pending" | "processing"): string {
  ...
  const intro =
    kind === "pending"
      ? "My poll payout has been pending for more than 2 hours."
      : "My poll payout has been processing for more than 2 hours."
    ...
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-10 text-center">
        ...
        <p className="text-sm text-gray-400 mt-1">
          Submitted payout requests for this poll will appear here.
        </p>
      </div>
    )
  }
