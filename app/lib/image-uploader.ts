 ...
 * Version 2.0.0 - Next.js Adaptation
 *
...
//
// Uploadthing
// - NEXT_PUBLIC_UPLOADTHING_API_KEY
//
// Firebase Storage
...
export async function deleteImageFromStorage(imageUrl: string): Promise<void> {
  try {
    ...
    // Use Firebase REST API to delete the file
    ...
    // Don't throw - allow the app to continue even if deletion fails
  }
}

/**
 * Uploads multiple images to Firebase Storage or Cloudinary
